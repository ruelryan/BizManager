...
const cspHeaders = {
  'Content-Security-Policy': "default-src 'self' data: https:; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; font-src 'self' data: https:; img-src 'self' data: https:; connect-src 'self' https:;",
...
function generateTestWebhookEvent(payload: any) {
  const baseEvent = {
