/*
  # Fix webhook and payment tables migration

  1. New Columns
     - Add plan, subscription_expiry, paypal_subscription_id, payment_status, and last_payment_date to user_settings
  
  2. New Tables
     - webhook_events: For tracking and processing webhook events
