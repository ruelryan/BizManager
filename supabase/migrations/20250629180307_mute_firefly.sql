/*
  ...
  1. New Tables
    ...
    - `notification_queue` - For user notifications about payments
  
  2. Changes
    - Add payment-related columns to `user_settings` table
    - Update `initialize_user_data` function to include new defaults
  
  3. Security
    - Enable RLS on all new tables
    - Add appropriate policies for service role and authenticated users
*/
