/*
  # Add Barcode Support and Return Handling

  1. Schema Updates
    - Add barcode column to products table
    - Add special_pricing column to customers table
    - Create returns table for return/refund processing
  ...
  3. Performance
    - Add indexes for barcode and return lookups
*/
